...
public class ChangeClarityDialog extends Dialog {
    ...
    private void init(Context context) {
        ...
        windowParams.width = ScreenUtils.getScreenHeight(context);
        windowParams.height = ScreenUtils.getScreenWidth(context);
    ...
    public void setClarityGrade(List<String> items, int defaultChecked) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            params.topMargin = (i == 0) ? 0 : ScreenUtils.dp2px(getContext(), 16);
